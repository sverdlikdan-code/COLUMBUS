...
function buildSlides() {
  ...
  // S5: Регионы — Эйлат: Эйлат +19%, не MMD
  dataSlide({
    pageNum: 5,
    ...
    analysis: t(
      '⚠️ Рост Эйлата +19% (2024→2025) НЕ органический!\n\n~60,000 эвакуированных удвоили население. Туристов = 0: порт -80% выручки (блокада Хусити). Но MMD работает с местной розницей — эвакуированные покупают ежедневно, месяцами.\n\nЭйлат +19% = рост вместе с рынком, не победа бренда.\n\nАрава -24% = другая история. Нет туристов, нет гостиниц/ресторанов — чисто местные: кибуцы, мошавы вдоль иорданской границы. Погранзоны закрыты → агент не мог приехать, клиенты частично эвакуированы.',
      '⚠️ +19% אילת (2024→2025) — לא אורגני!\n~60,000 מפונים (מ-7.10.2023) הכפילו אוכלוסייה. תיירים = 0: רמון ללא טיסות, נמל אילת — הכנסות -80% (212M→42M ₪), בסף סגירה (חות׳ים חסמו ים סוף). כל קמעונאות אילת עלתה ~18-22% (StoreNext). Эйлат +19% = מגמת שוק, לא ניצחון מותג.\nערבה -24% (2024→2025) = אזורים גבוליים סגורים.',
      '⚠️ +19% Eilat (2024→2025) NOT organic!\n~60K evacuees (since Oct 7, 2023) doubled population. Tourists = 0: Eilat port revenue -80% (212M→42M ₪), near closure (Houthi Red Sea blockade). All Eilat retail grew ~18-22% (StoreNext). Эйлат +19% = market trend, not brand win.\nArava -24% (2024→2025) = border zones closed since Oct 2023.'
    ),
    rec: t(
