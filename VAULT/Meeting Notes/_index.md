...
- [[formula-road-app]] — Formula Road + zikuy: SQL migration, tablet UX, DESIGN.md (2026-08-17); TTS built+removed, family drilldown, DAX context-transition баг в INTER, יעד-таргет, day-briefing редизайн, конкурентные git-сессии, менеджерский инвайт + рассылка 40 писем, баг INDICATION (месячный фильтр), округление до целых везде (2026-08-18)
